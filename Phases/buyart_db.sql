...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 13 Kas 2019, 20:28:27
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `transaction` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `artist` FOREIGN KEY (`artist_id`) REFERENCES `artistprofile` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Tablo kısıtlamaları `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `artist_user` FOREIGN KEY (`artist_id`) REFERENCES `artistprofile` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
